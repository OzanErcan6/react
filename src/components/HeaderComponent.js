...
import { Nav, Navbar, NavbarBrand, NavbarToggler, Collapse, NavItem, 
    Jumbotron, Button, Modal, ModalHeader, ModalBody,Form, FormGroup, Label, Input } from 'reactstrap';
                ...
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <NavItem>
                                <NavLink className="nav-link" to='/ozan'><span className="fa fa-address-card fa-lg"></span> Ozan</NavLink>
                            </NavItem>
                            </Nav>
